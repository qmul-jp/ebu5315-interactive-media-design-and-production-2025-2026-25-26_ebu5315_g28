...
const translations = {
    en: {
        ...
        // 主内容区
        breadcrumbCurrent: 'Angles in a Semicircle',
        detailTitle: 'Circle Theorem 2: Angles in a Semicircle',
        backBtn: 'Back to All Theorems',
        infoTitle: 'How to Explore',
        infoPoint1: 'Drag point <strong>C</strong> around the semicircle.',
        infoPoint2: 'Watch how the angle changes in real-time.',
        infoPoint3: 'Observe that <span class="formula">∠ACB = 90°</span> always.',
        // 数据面板
    ...
    zh: {
        ...
        breadcrumbGame: '交互定理',
        // 主内容区
        breadcrumbCurrent: '半圆上的角',
        detailTitle: '圆定理 2：半圆上的角',
        backBtn: '返回全部定理',
        infoTitle: '如何探索',
        infoPoint1: '拖动半圆上的点 <strong>C</strong>。',
        infoPoint2: '观察角度如何实时变化。',
        infoPoint3: '观察这个固定关系：<span class="formula">∠ACB = 90°</span>',
        // 数据面板
        angleLabel: '角度 ∠ACB',
        // 边栏
        sidebarTitle: '定理列表',
